...
function ShippingFeatures() {
    const features = [
        {
            icon: <LazyMedia type={'image'} src='/images/icons/delivery.png' className={styles.icon} alt='truck' />,
            title: 'Livraison Gratuite',
            description: 'Bénéficiez de la livraison gratuite pour toute commande supérieure à 50 DH.'
        },
        {
            icon: <LazyMedia type={'image'} src='/images/icons/delivery-status.png' className={styles.icon} alt='package' />,
            title: 'Retours Gratuits',
            description: 'Retournez vos produits gratuitement dans les 30 jours suivant votre achat.'
        },
        {
            icon: <LazyMedia type={'image'} src='/images/icons/express-delivery.png' className={styles.icon} alt='clock' />,
            title: 'Livraison Express',
            description: 'Recevez votre commande en 24 à 48 heures, selon votre localisation.'
        },        
        {
            icon: <LazyMedia type={'image'} src='/images/icons/payment-protection.png' className={styles.icon} alt='shield' />,
